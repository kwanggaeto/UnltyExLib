        ...
        protected override void OnPopulateMesh(VertexHelper vh)
        {
            ...
            if (tex != null)
            {
                ...
                var scaleY = tex.height * tex.texelSize.y;
                {
                    ...
                    uvs[0] = new Vector2(m_UVRect.xMin * scaleX, m_UVRect.yMin * scaleY);
                    uvs[1] = new Vector2(m_UVRect.xMin * scaleX, m_UVRect.yMax * scaleY);
                    uvs[2] = new Vector2(m_UVRect.xMax * scaleX, m_UVRect.yMax * scaleY);
                    uvs[3] = new Vector2(m_UVRect.xMax * scaleX, m_UVRect.yMin * scaleY);
                    vh.AddVert(new Vector3(v.x, v.y), grad.Evaluate(uvs[0].x), uvs[0]);
                    vh.AddVert(new Vector3(v.x, v.w), grad.Evaluate(uvs[1].x), uvs[1]);
                    vh.AddVert(new Vector3(v.z, v.w), grad.Evaluate(uvs[2].x), uvs[2]);
                    vh.AddVert(new Vector3(v.z, v.y), grad.Evaluate(uvs[3].x), uvs[3]);
