...
namespace ExLib.UI
{
    ...
    /// </summary>
    public class UnMaskableImage : Graphic, ISerializationCallbackReceiver, ILayoutElement, ICanvasRaycastFilter
    {
        /// <summary>
        ...
        /// </remarks>
        public Type type { get { return m_Type; } set { if (SetStruct(ref m_Type, value)) SetVerticesDirty(); } }
        ...
        /// </summary>
        public bool preserveAspect { get { return m_PreserveAspect; } set { if (SetStruct(ref m_PreserveAspect, value)) SetVerticesDirty(); } }
        ...
        /// </code>
        /// </example>
        public bool fillCenter { get { return m_FillCenter; } set { if (SetStruct(ref m_FillCenter, value)) SetVerticesDirty(); } }

        /// Filling method for filled sprites.
        [SerializeField] private FillMethod m_FillMethod = FillMethod.Radial360;
        public FillMethod fillMethod { get { return m_FillMethod; } set { if (SetStruct(ref m_FillMethod, value)) { SetVerticesDirty(); m_FillOrigin = 0; } } }
        ...
        /// </code>
        /// </example>
        public float fillAmount { get { return m_FillAmount; } set { if (SetStruct(ref m_FillAmount, Mathf.Clamp01(value))) SetVerticesDirty(); } }
        ...
        /// </code>
        /// </example>
        public bool fillClockwise { get { return m_FillClockwise; } set { if (SetStruct(ref m_FillClockwise, value)) SetVerticesDirty(); } }
        ...
        /// </code>
        /// </example>
        public int fillOrigin { get { return m_FillOrigin; } set { if (SetStruct(ref m_FillOrigin, value)) SetVerticesDirty(); } }
        ...
        /// </remarks>
        public bool useSpriteMesh { get { return m_UseSpriteMesh; } set { if (SetStruct(ref m_UseSpriteMesh, value)) SetVerticesDirty(); } }


        protected UnMaskableImage()
        {
        ...
        static List<UnMaskableImage> m_TrackedTexturelessImages = new List<UnMaskableImage>();
        ...
        private static void TrackImage(UnMaskableImage g)
        {
            if (!s_Initialized)
            {
        ...
        private static void UnTrackImage(UnMaskableImage g)
        {
            m_TrackedTexturelessImages.Remove(g);
        }


        public bool SetColor(ref Color currentValue, Color newValue)
        {
        ...
        public bool SetClass<T>(ref T currentValue, T newValue) where T : class
        {
