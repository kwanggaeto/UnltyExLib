    ...
    public class UnMaskableImageEditor : GraphicEditor
    {
        ...
        protected void SpriteGUI()
        {
            ...
            if (EditorGUI.EndChangeCheck())
            {
                ...
                (serializedObject.targetObject as UnMaskableImage).DisableSpriteOptimizations();
            }
        }
        ...
        protected void TypeGUI()
        {
            ...
            ++EditorGUI.indentLevel;
            {
                ...
                UnMaskableImage image = target as UnMaskableImage;
