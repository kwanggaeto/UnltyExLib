        ...
        if (Drawings == null)
        {
            ...
            else if (_showingIcons)
            {
                ...
                foreach (UnityEngine.Object oo in _objects)
                {
                    ...
                    float height = texture.height + GUI.skin.button.CalcSize(new GUIContent(texture.name)).y +
                    ...
                    draw.Draw = () =>
                    {
                        ...
                        bool oldEdit = EditorGUIUtility.editingTextField;
                        //EditorGUIUtility.editingTextField = false;
                        if (GUILayout.Button("Save"))
                        {
                            string path = EditorUtility.SaveFilePanel("저장할 경로를 지정해 주세요", System.Environment.CurrentDirectory, "texture", "png");
                        ...
                        //EditorGUIUtility.editingTextField = oldEdit;
